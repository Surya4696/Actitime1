...
public class TestIssueDate extends BaseTest
{
	...
	{
		String username=FWUtils.read_XL_Data(XL_DATA_PATH, "CheckIssueDate", 1, 0);
		String password=FWUtils.read_XL_Data(XL_DATA_PATH, "CheckIssueDate", 1, 1);
		String etitle=FWUtils.read_XL_Data(XL_DATA_PATH, "EnterTimeTrack", 1, 2);
		String etitlelcp=FWUtils.read_XL_Data(XL_DATA_PATH, "CheckIssueDate", 1, 2);
		String expectedissuedate=FWUtils.read_XL_Data(XL_DATA_PATH, "CheckIssueDate", 1, 3);
		...
		lcp.issueDATE(expectedissuedate);
